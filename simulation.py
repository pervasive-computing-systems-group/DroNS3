...
if __name__ == '__main__':
	w = Wrapper()
	w.start_mission(mission=missions.General(w.vehicle, mission_file="sample_wsn_mission/drone_plan.pln", debug = True, custom_commands=[Custom_Command], is_sim=True))
